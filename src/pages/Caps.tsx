  ...
  const capsItems = [
    {
      ...
      image: '/images/cap_1.jpeg',
      price: '₦15,000',
    },
    {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_2.jpeg',
      price: '₦15,000',
    },
    {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_3.jpeg',
      price: '₦15,000',
    },
    {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_4.jpeg',
      price: '₦15,000',
    },
    {
      name: 'Designer Caps',
    ...
    },
{
    ...
    },
    {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_8.jpeg',
      price: '₦15,000',
    },
    {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_9.jpeg',
      price: '₦15,000',
    },
   {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_10.jpeg',
      price: '₦15,000',
    },
    {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_11.jpeg',
      price: '₦15,000',
    },
    {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_12.jpeg',
      price: '₦15,000',
    },
    {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_13.jpeg',
      price: '₦15,000',
    },
   {
      name: 'Designer Caps',
      description: `These caps are made for easy days and intentional fits clean embroidery, structured shape, and colors that slide effortlessly into your wardrobe.`,
      image: '/images/cap_14.jpeg',
      price: '₦15,000',
    },
  ];
    ...
    <div className="min-h-screen pt-20">
      <section className="py-16 px-4 bg-gradient-to-br from-amber-50 to-stone-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover our premium selection of designer caps, crafted for style and comfort with premium materials.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-amber-50 to-stone-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="https://wa.me/2348124238750?text=I%20would%20like%20to%20know%20about%20new%20caps%20collections%20coming%20soon."
            target="_blank"
