...
export default function Wristwatches() {
  ...
  const wristwatchItems = [
    ...
    },
    {
      ...
      category: 'Wristwatches',
      description: `Precision meets presence.

Bold design, clean structure, and a finish that commands attention without trying too hard.
Fully boxed and available in different colors, these Hublot watches are made for everyday confidence and elevated moments alike.`,
      image: '/images/Hublot_1.jpg',
      price: '₦27,000',
    },
    {
      name: 'Hublot Classic Fusion',
